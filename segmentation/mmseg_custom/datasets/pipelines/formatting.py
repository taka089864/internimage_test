...
from mmseg.datasets.transforms.formatting import to_tensor

# Compatibility wrapper for DataContainer (DC) since it was removed in mmcv 2.x
class DC:
    """Wrapper to maintain backward compatibility with old DataContainer usage."""
...
@PIPELINES.register_module(force=True)
class TeethFormatBundle(object):
    """teeth formatting bundle.
